...
Open the Airbnb host calendar for a single listing, click the extension, and export the next 12 months of visible nightly rates. If Airbnb increased your displayed prices, enter that percentage and the extension will convert them back to their pre-increase amounts before saving the CSV. The CSV opens in Excel, Numbers, Google Sheets, or tools that import rate data.
